...
This document captures the architectural direction for hivemoot-agent, evolving
from the discussions in [#6](https://github.com/hivemoot/hivemoot-agent/issues/6).
