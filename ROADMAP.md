...
- How does the controller communicate with workers? (stdin/stdout streaming, HTTP, or something else?)
- Should we support hybrid setups where some agents run in-container and others via controller?
- What's the migration path for existing users when Phase 2 lands?
